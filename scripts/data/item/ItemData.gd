...
## 🔥 【新增】：燃料与热力学属性 (只有当 action_tags 包含 "fuel" 标签时，系统才会读取这些值)
@export_group("燃料与热力学属性  (Fuel Properties)")
@export var fuel_minutes: float = 0.0  ## 提供多少分钟的燃烧时间 (例：木头=60)
@export var heat_level: float = 0.0    ## 燃烧时提供的基础温度 (例：木头=1)
@export var ash_yield: float = 0.0     ## 完全燃烧后产生多少单位的灰烬 (例：木头=1)
